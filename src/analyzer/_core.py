...
6. **舆情诚实**：`intelligence.sentiment_summary` 不得在无检索结果时臆断“平静”。若 `search_performed` 为 false 或未检索到任何新闻，必须如实写明“未检索到相关公开消息（搜索源未配置/不可用）”或“暂无公开消息”，不得用“消息面平静”掩盖数据缺失；舆情数据缺失时 `confidence_level` 不得为高，并在 `data_limitations` 中标注“舆情数据缺失”。
...
__all__ = ['logger', '_localized_text', '_normalize_risk_warning_values', '_today_has_realtime_overlay', '_today_looks_complete_daily_bar', '_phase_aware_quote_labels', '_should_hide_regular_session_ohlc', '_legacy_market_group', '_legacy_audit_marker_specs', '_LiteLLMStreamError', '_AllModelsFailedError', 'check_content_integrity', 'apply_placeholder_fill', '_CHIP_KEYS', '_is_value_placeholder', '_RISK_WARNING_PLACEHOLDER_TEXTS', '_STRUCTURAL_RISK_PHRASE_HINTS', '_CAPITAL_FLOW_UNAVAILABLE_STATUS', '_is_meaningful_text', '_safe_float', '_coerce_chip_metric', '_BULLISH_TREND_HINTS', '_WEAK_BULLISH_TREND_HINTS', '_BEARISH_TREND_HINTS', '_WEAK_BEARISH_TREND_HINTS', '_NEGATION_TOKENS', '_NEGATION_BREAK_CHARS', '_NEGATION_LOOKBACK_CHARS', '_NEGATION_MAX_GAP_CHARS', '_NEGATION_SCOPE_BREAK_TOKENS', '_SINGLE_CHAR_NEGATION_GAP_PREFIXES', '_normalize_prompt_reason_items', '_contains_trend_hint', '_infer_trend_direction', '_filter_conflicting_trend_items', '_sanitize_trend_analysis_for_prompt', '_derive_chip_health', '_build_chip_structure_from_data', '_has_meaningful_chip_data', '_mark_chip_structure_unavailable', 'normalize_chip_structure_availability', 'fill_chip_structure_if_needed', '_PRICE_POS_KEYS', 'fill_price_position_if_needed', 'stabilize_decision_with_structure', '_has_structural_risk_alert', '_is_significant_structural_risk', '_sync_stability_dashboard_fields', '_as_dict_for_decision_guard', '_first_list_value', '_coerce_numeric_value', '_first_numeric_value', '_capital_flow_bias', '_capital_flow_bias_with_status', '_capital_flow_status_for_stability', '_set_decision_stability_unavailable', '_record_decision_score_calibration', '_bound_hold_watch_sentiment_score', '_apply_hold_watch_dashboard', '_downgrade_buy_without_capital_flow', '_downgrade_to_structural_hold', '_set_structural_hold_wording', 'get_stock_name_multi_source', 'AnalysisResult', 'populate_decision_action_fields', 'GeminiAnalyzer', 'get_analyzer']
