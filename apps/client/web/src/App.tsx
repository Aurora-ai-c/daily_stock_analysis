...
import { shouldShowWizard, type DsaBridge } from './components/setup/shouldShowWizard';
...
const SetupWizardGate: React.FC = () => {
  const [show, setShow] = useState(false);
  useEffect(() => {
    const dsa = (window as unknown as { dsa?: DsaBridge }).dsa;
    shouldShowWizard(dsa).then(setShow).catch(() => setShow(false));
  }, []);
  if (!show) return null;
